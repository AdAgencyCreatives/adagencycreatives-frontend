              ...
              <Grid item lg={9} md={10} xs={4} sx={{ textAlign: "right", padding: "10px" }} className="right-menu">
                <Box sx={{ display: { md: "none", display: "flex", alignItems: "center", justifyContent: "center" } }}>
                  ...
                  <Link
                    ...
                    onClick={(e) => validateAccess(e, { roles: ["admin", "agency"], restrictedMessage: "Please login as a Agency to access" })}
                  >
                    P
                  </Link>
                ...
                >
                  ...
                  <Button
                    ...
                    onClick={(e) => validateAccess(e, { roles: ["admin", "agency", "advisor", "recruiter"], restrictedMessage: "Please login as a Agency to access" })}
                  >
                    Post A Job
                  </Button>
                  {state.token ? (
