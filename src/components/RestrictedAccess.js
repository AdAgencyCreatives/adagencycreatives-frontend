...
const RestrictedAccess = ({ title = "Restricted Access", message = "Login to view this page.", delay = 30000, delayTitle = '', delayMessage = <CircularProgress /> }) => {
    ...
    return timedLoading ? (
        <div className="dark-container page-community mb-0 mt-4">
            <h1 className="community-title">{delayTitle}</h1>
